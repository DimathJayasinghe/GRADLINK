...
<div>
    ...
    <h2>Open Campaigns
        <p style="font-size: small;font-weight:bold;color: var(--muted);margin-top:13px;margin-bottom:50px">Explore all current fundraisers — support a cause today.</p>
    </h2>
        ...
        <div class="cards-container">
            ...
            ?>
                <div class="card <?php
                    ...
                    <?php if (!$expired) {
                        echo '<p>Time Left: ' . $timeleft->days . ' days</p>';
                    } ?>
