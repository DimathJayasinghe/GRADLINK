...
<div class="admin-dashboard">
    ...
    <section class="grid-3">
        ...
        <div class="card">
            ...
            <ul class="list">
                <li><span>Total Posts</span><strong id="metric-posts">—</strong></li>
                <li><span>Total Comments</span><strong id="metric-comments">—</strong></li>
                <li><span>Total Reactions</span><strong id="metric-reactions">—</strong></li>
            </ul>
        </div>
        <div class="card">
