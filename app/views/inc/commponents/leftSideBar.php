...
<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        <li id="home-btn" onclick="window.location.href='<?php echo URLROOT; ?>/mainfeed'">
        ...
        <li id="messages-btn" onclick="window.location.href='<?php echo URLROOT; ?>/messages'">
            <i class="fas fa-envelope"></i><span>Messages</span>
        </li>
        <li id="bookmark-btn" onclick="window.location.href='<?php echo URLROOT; ?>/bookmark'">
            <i class="fas fa-bookmark"></i><span>Bookmarks</span>
        </li>
        <li id="profile-btn" onclick="window.location.href='<?php echo URLROOT; ?>/profile'">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const notificationsData = [{
                type: 'like',
                user: 'Tech Careers',
                userImg: URLROOT_JS + '/img/follow-1.jpg',
                content: 'liked your post about job interview tips.',
                time: '2 hours ago'
            },
            {
                type: 'follow',
                user: 'Dr. Sarah Johnson',
                userImg: URLROOT_JS + '/img/professor-profile.jpg',
            ...
            },
            {
                type: 'mention',
                user: 'Grad Network',
                userImg: URLROOT_JS + '/img/follow-2.jpg',
            ...
            },
            {
                type: 'comment',
                user: 'Jane Smith',
                userImg: URLROOT_JS + '/img/default-profile.jpg',
                content: 'commented: "Great insights!"',
                time: '3 days ago'
            },
            {
                type: 'event',
                user: 'IEEE Student Branch',
                userImg: URLROOT_JS + '/img/ieee-logo.jpg',
                content: 'posted an event: "IEEE INTRODUCTORY SESSION"',
                time: '1 week ago'
            }
        ];
