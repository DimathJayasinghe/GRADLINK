...
<div class="right-sidebar">
    ...
    <div class="card">
        ...
        <div class="event">
            <div class="event-category"><i class="fas fa-hand-holding-heart"></i><span>Student Support</span></div>
            <div class="event-name">Help John Doe complete his research</div>
            <div class="sidebar-event-date"><i class="fas fa-donate"></i><span>$700 raised of $1000</span></div>
        </div>
        <div class="event">
            <div class="event-category"><i class="fas fa-hand-holding-heart"></i><span>Community</span></div>
            <div class="event-name">Device Drive for Freshers</div>
            <div class="sidebar-event-date"><i class="fas fa-donate"></i><span>$1,250 raised of $2,500</span></div>
        </div>
        <div class="show-more">View all</div>
    </div>
